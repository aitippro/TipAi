...
| 复杂度 | 框架 |
|--------|------|
| **简单** (8) | RTF · APE · TAG · CARE · BAB · SMART · Compare-Contrast · Brainstorming |
| **中等** (11) | CO-STAR · RISEN · CRISPE · BROKE · SCQA · PROMPT · Few-Shot · Multi-Translate · Persona+ · Crisis-Response · Data-Storytelling |
| **复杂** (11) | Chain-of-Thought · Tree-of-Thoughts · ReAct · LangGPT · APE+ · Self-Refine · Meta-Prompting · Security-Audit · Scientific-Experiment · Medical-Diagnosis · Legal-Analysis |
...
| API | tRPC 11 · Hono 4 (in-process, no HTTP server) |
| 数据库 | **Rust Native Addon** (rusqlite) 主驱动 · better-sqlite3 回退 · 纯 TypeScript 类型定义 |
...
- **零端口架构**: 无 HTTP 服务器，Hono + tRPC 在 Electron 进程内运行
- **IPC 通信**: 渲染进程通过 Electron IPC 调用 API，无需网络端口
- **Rust Native Addon**: 数据库操作 + AI HTTP + 加密全部下沉到 Rust
- **本地优先**: 无注册/登录，无网络认证，所有数据存储在用户本地
