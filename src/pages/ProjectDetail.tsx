...
export default function ProjectDetail() {
  ...
  const renderedTurns = useMemo(() => {
    ...
    const turns: ConversationTurn[] = (conversation as Array<{ id: number; role: "user" | "assistant" | "system"; content: string; turnNumber?: number; createdAt?: string | Date }>).map((turnData) => ({
      id: turnData.id,
      role: turnData.role,
      content: turnData.content,
      turnNumber: turnData.turnNumber ?? 0,
      createdAt: turnData.createdAt ? new Date(turnData.createdAt as string | Date) : null,
    }))
  ...
  }, [conversation, shouldReduceMotion, t])
