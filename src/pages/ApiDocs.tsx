...
const ENDPOINTS = [
  {
    ...
    path: "/api/rest/ping",
    desc: "健康检查",
    example: `curl http://localhost:3000/api/rest/ping`,
  ...
  },
  {
    ...
    desc: "智能框架匹配",
    example: `curl -X POST http://localhost:3000/api/rest/framework/match \\\n  -H "Content-Type: application/json" \\\n  -d '{"intent": "帮我写一个Python爬虫"}'`,
  ...
  },
  {
    ...
    desc: "质量门禁检查",
    example: `curl -X POST http://localhost:3000/api/rest/quality-gate/check \\\n  -H "Content-Type: application/json" \\\n  -d '{"prompt": "你是一位专家，请分析...", "threshold": 70}'`,
    response: `{\n  "overallScore": 85,\n  "passed": true,\n  "checks": [...]\n}`,
  },
  {
    method: "POST",
    ...
    desc: "多模态提示词生成",
    example: `curl -X POST http://localhost:3000/api/rest/multimodal/generate \\\n  -H "Content-Type: application/json" \\\n  -d '{"request": "一只穿宇航服的猫", "mode": "text-to-image"}'`,
    response: `{\n  "generatedPrompts": [...],\n  "tips": [...]\n}`,
  },
  {
    method: "POST",
    ...
    example: `curl -X POST http://localhost:3000/api/rest/tot/solve \\\n  -H "Content-Type: application/json" \\\n  -d '{"problem": "如何在O(n)内找第k大元素", "strategy": "bfs"}'`,
    response: `{\n  "tree": {...},\n  "bestPath": [...],\n  "stats": {...}\n}`,
  },
  {
    method: "POST",
    ...
    desc: "学术引用生成",
    example: `curl -X POST http://localhost:3000/api/rest/academic/citations \\\n  -H "Content-Type: application/json" \\\n  -d '{"text": "LLM prompt engineering", "format": "apa"}'`,
    response: `{\n  "citations": [...],\n  "extractedKeywords": [...]\n}`,
  },
];
